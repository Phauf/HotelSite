...
Adding the Engine to a WordPress Page Using the Page Editor:
...
Adding the Engine to a WordPress Page Using "Add a Widget":
...
3. Click the option "Add a Widget", then find and select the Text widget from the list.
4. In the text area, paste the shortcode generated in Sirvoy. Press the Publish button and reload the page to see the results.

...
class JLanguage
{
	...
	public function load($extension, $basePath = '', $lang = null)
	{
		...
		// remove these filters to avoid affecting other plugins
		remove_filter('load_textdomain_mofile', array($this, 'preventPolylangHack'));
		remove_filter('load_textdomain_mofile', array($this, 'storeDefaultMofile'));
	 ...
	 */
	public function getLocaleFilter($locale)
	{	
		/**
